...
import { auth } from "../../config/firebase";  // Adjusted the path to match your structure
import ChangeEmail from "../ChangeEmail";  // No change needed as the test file is inside `_tests__`
